...
/****** WRITE HANDLE *******/
/**
 * handle_write_char - Prints a charactors to std-output
...
int width, int precision, int size)
{
	...
	if (width > 1)
	{
		/*/ writing to the buffer padding charactor */
 ...
 * @precision: Precision specification of printed charactor
 * @size: int, that specifies the size of printed charactor
 * @buffer: list of arguments collected
 * Return: Number of chars printed.
 */
 ...
 * @flags:  shows how the charactor prints = c, d, i, f, p
 * @width: the minimum width of the printed charactor
 * @length: int, that specifies the size of printed charactor
 * @padd: Pading char
 * @extra_c: Extra char
...
int width, int flags, char padd, char extra_c, int padd_start)
{
	...
	if (width > length)
	{
		for (i = 3; i < width - length + 3; i++)
			buffer[i] = padd;
		buffer[i] = '\0';
		/*/ assigning another char to the left of the buffer */
		...
		/*/ adding extra char to the left of padd */
